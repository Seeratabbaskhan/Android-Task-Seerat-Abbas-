...
public class MainTitleCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<MainCategoryModel> mainCategoryArrayList;
    Context context;

    public MainTitleCategoryAdapter(Context context, ArrayList<MainCategoryModel> mainCategoryArrayList) {
