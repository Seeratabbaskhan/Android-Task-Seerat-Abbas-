...
public class TitleCategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<TitleCategoryModel> titleCategoryModelArrayList;
    Context context;

    public TitleCategoryAdapter(Context context, ArrayList<TitleCategoryModel> titleCategoryModelArrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item_title_category, parent, false));
